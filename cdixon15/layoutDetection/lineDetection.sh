...
#SBATCH --output=/project/arcc-students/cdixon15/oilCardProject/oil-Card-Rebase/sbatchOutput/lineDetection/output.txt
#SBATCH --error=/project/arcc-students/cdixon15/oilCardProject/oil-Card-Rebase/sbatchOutput/lineDetection/error.txt
...
python /project/arcc-students/cdixon15/oilCardProject/oil_Card_Git/Oil_Well_Cards_OCR/cdixon15/layoutDetection/lineDetection.py -i "/project/arcc-students/cdixon15/oilCardProject/layoutSeparation/testInputs/310-0000.pdf" -o "/project/arcc-students/cdixon15/oilCardProject/oil-Card-Rebase/processed/lineDetection"