...
python -u /project/arcc-students/csloan5/OilWellCards/text_parsing/type1_card_parser.py -i "/pfs/tc1/project/arcc-students/OilWellProject2023.Summer/Type_1_CSVs/" -o "/pfs/tc1/project/arcc-students/csloan5/OilWellCards/type1_cards_parsed_Finished.csv"
